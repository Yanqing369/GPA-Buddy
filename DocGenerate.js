...
const i18n = {
    zh: {
        ...
        donate: '捐款',
        donateBannerText: '测试期间免费试用，可以签到获得积分',
        supportUs: '支持我们',
    ...
    'zh-TW': {
        ...
        donate: '捐款',
        donateBannerText: '測試期間免費試用，可以簽到獲得積分',
        supportUs: '支持我們',
    ...
    en: {
        ...
        donate: 'Donate',
        donateBannerText: 'Free trial during the testing period — earn points by checking in',
    ...
    ko: {
        ...
        donate: '기부',
        donateBannerText: '테스트 기간 동안 무료로 체험할 수 있습니다. 출석 체크로 포인트를 받아보세요.',
        supportUs: '후원하기',
